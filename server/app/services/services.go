...
func Reg(c *gin.Context, db *gorm.DB) {
...
func Post(c *gin.Context, db *gorm.DB) {
...
func PutPost(c *gin.Context, db *gorm.DB) {
...
func DelePost(c *gin.Context, db *gorm.DB) {
...
func ReportPost(c *gin.Context, db *gorm.DB) {
...
func AdminGetReport(c *gin.Context, db *gorm.DB) {
	UserID := c.DefaultQuery("user_id", "0")
	UserID = UserID
	var TarReport []models.Reports
...
func AdminProReport(c *gin.Context, db *gorm.DB) {
